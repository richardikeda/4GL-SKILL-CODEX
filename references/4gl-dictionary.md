...
Canonical dictionary for Sage X3 4GL, rewritten from mined sources and normalized for daily skill use.
...
- Description: This function defines a filtering condition on a database query. The condition is expressed in <a target="_blank" href="https://sage.github.io/SData-2.0/pages/core/0212/">SData _where_ syntax</a>.
...
- Description: The maxheap variable defines the memory (in bytes) that can be allocated in the heap memory of the adonix server process.
- Validation: `confirmed-help-only`
- Sources: x3-helper
...
- Description: The maxmem variable defines the memory (in bytes) that can be allocated in the main memory of the Adonix server process.
- Validation: `confirmed-help-only`
- Sources: x3-helper
...
- Description: This function returns a string value containing an <a target="_blank" href="https://sage.github.io/SData-2.0/pages/core/0212/">SData _where_ syntax</a> corresponding to a $$PRODUCT valid condition.
- Validation: `confirmed-help-only`
- Sources: x3-helper
...
- Validation: `confirmed`
- Sources: plugin-snippets
- Example: `If GUSER="RIIK" : Dbgaff : Endif`
...
- Validation: `confirmed`
- Sources: plugin-snippets
- Example: `If GUSER="RIIK" : Call SETDEBUGJON From DEBUGGERJ : Dbgaff : Endif`
...
- Validation: `confirmed`
- Sources: plugin-snippets
- Example: `If GUSER="RIIK"   Local integer RIIKRET   Call OUINON("Debug question} ?",RIIKRET) From GESECRAN   If RIIKRET=2`
...
- Validation: `confirmed`
- Sources: plugin-snippets
- Example: `If GUSER="RIIK"     Infbox "LABEL}" Endif`
...
- Description: The 'Freeheap' function returns the number of bytes not used in the heap memory of the Adonix server process.
- Validation: `confirmed`
- Sources: x3-helper
- Example: `freeheap`
...
- Description: The 'Freemem' function returns the number of bytes not used in the main memory of the Adonix server process.
- Validation: `confirmed`
- Sources: x3-helper
- Example: `freemem`
